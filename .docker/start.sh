...
if [ "$role" = "django-http" ]; then
  ...
  if [ "True" = $SHOP_HOST1_REGISTER ]; then
    python3 manage.py create_host --owner=$DJANGO_OPERATOR_NAME --sitedomain="$SHOP_SITE_DOMAIN" --name="$SHOP_HOST1_NAME" --description="$SHOP_HOST1_DESCRIPTION" --ip=$SHOP_HOST1_IP --portranges=$SHOP_HOST1_PORT_RANGES --rangetype=$SHOP_HOST1_PORT_RANGE_TYPE --isenabled=$SHOP_HOST1_IS_ENABLED --isalive=$SHOP_HOST1_IS_ALIVE --istesthost=$SHOP_HOST1_IS_TESTHOST --istestnet=$SHOP_HOST1_IS_TESTNET --offerstorbridges=$SHOP_HOST1_OFFERS_TOR_BRIDGES --torbridgeduration=$SHOP_HOST1_TOR_BRIDGE_DURATION --torbridgepriceinitial=$SHOP_HOST1_TOR_BRIDGE_PRICE_INITIAL --torbridgepriceextension=$SHOP_HOST1_TOR_BRIDGE_PRICE_EXTENSION --offersnostraliases=$SHOP_HOST1_OFFERS_NOSTR_ALIASES --nostraliasport=$SHOP_HOST1_NOSTR_ALIAS_PORT --nostraliasduration=$SHOP_HOST1_NOSTR_ALIAS_DURATION --nostraliaspriceinitial=$SHOP_HOST1_NOSTR_ALIAS_PRICE_INITIAL --nostraliaspriceextension=$SHOP_HOST1_NOSTR_ALIAS_PRICE_EXTENSION --offersrsshtunnels=$SHOP_HOST1_OFFERS_RSSH_TUNNELS --rsshtunnelprice=$SHOP_HOST1_RSSH_TUNNEL_PRICE --tos="$SHOP_HOST1_TERMS_OF_SERVICE" --tosurl="$SHOP_HOST1_TERMS_OF_SERVICE_URL" --cistatus=$SHOP_HOST1_CI_STATUS --cidate="$SHOP_HOST1_CI_DATE" --cimessage="$SHOP_HOST1_CI_MESSAGE" --bridge_bandwidth_initial=$SHOP_HOST1_BRIDGE_BANDWIDTH_INITIAL
  fi
  if [ "True" = $SHOP_HOST2_REGISTER ]; then
    python3 manage.py create_host --owner=$DJANGO_OPERATOR_NAME --sitedomain="$SHOP_SITE_DOMAIN" --name="$SHOP_HOST2_NAME" --description="$SHOP_HOST2_DESCRIPTION" --ip=$SHOP_HOST2_IP --portranges=$SHOP_HOST2_PORT_RANGES --rangetype=$SHOP_HOST2_PORT_RANGE_TYPE --isenabled=$SHOP_HOST2_IS_ENABLED --isalive=$SHOP_HOST2_IS_ALIVE --istesthost=$SHOP_HOST2_IS_TESTHOST --istestnet=$SHOP_HOST2_IS_TESTNET --offerstorbridges=$SHOP_HOST2_OFFERS_TOR_BRIDGES --torbridgeduration=$SHOP_HOST2_TOR_BRIDGE_DURATION --torbridgepriceinitial=$SHOP_HOST2_TOR_BRIDGE_PRICE_INITIAL --torbridgepriceextension=$SHOP_HOST2_TOR_BRIDGE_PRICE_EXTENSION --offersnostraliases=$SHOP_HOST2_OFFERS_NOSTR_ALIASES --nostraliasport=$SHOP_HOST2_NOSTR_ALIAS_PORT --nostraliasduration=$SHOP_HOST2_NOSTR_ALIAS_DURATION --nostraliaspriceinitial=$SHOP_HOST2_NOSTR_ALIAS_PRICE_INITIAL --nostraliaspriceextension=$SHOP_HOST2_NOSTR_ALIAS_PRICE_EXTENSION --offersrsshtunnels=$SHOP_HOST2_OFFERS_RSSH_TUNNELS --rsshtunnelprice=$SHOP_HOST2_RSSH_TUNNEL_PRICE --tos="$SHOP_HOST2_TERMS_OF_SERVICE" --tosurl="$SHOP_HOST2_TERMS_OF_SERVICE_URL" --cistatus=$SHOP_HOST2_CI_STATUS --cidate="$SHOP_HOST2_CI_DATE" --cimessage="$SHOP_HOST2_CI_MESSAGE" --bridge_bandwidth_initial=$SHOP_HOST2_BRIDGE_BANDWIDTH_INITIAL
  fi
  if [ "True" = $SHOP_HOST3_REGISTER ]; then
    python3 manage.py create_host --owner=$DJANGO_OPERATOR_NAME --sitedomain="$SHOP_SITE_DOMAIN" --name="$SHOP_HOST3_NAME" --description="$SHOP_HOST3_DESCRIPTION" --ip=$SHOP_HOST3_IP --portranges=$SHOP_HOST3_PORT_RANGES --rangetype=$SHOP_HOST3_PORT_RANGE_TYPE --isenabled=$SHOP_HOST3_IS_ENABLED --isalive=$SHOP_HOST3_IS_ALIVE --istesthost=$SHOP_HOST3_IS_TESTHOST --istestnet=$SHOP_HOST3_IS_TESTNET --offerstorbridges=$SHOP_HOST3_OFFERS_TOR_BRIDGES --torbridgeduration=$SHOP_HOST3_TOR_BRIDGE_DURATION --torbridgepriceinitial=$SHOP_HOST3_TOR_BRIDGE_PRICE_INITIAL --torbridgepriceextension=$SHOP_HOST3_TOR_BRIDGE_PRICE_EXTENSION --offersnostraliases=$SHOP_HOST3_OFFERS_NOSTR_ALIASES --nostraliasport=$SHOP_HOST3_NOSTR_ALIAS_PORT --nostraliasduration=$SHOP_HOST3_NOSTR_ALIAS_DURATION --nostraliaspriceinitial=$SHOP_HOST3_NOSTR_ALIAS_PRICE_INITIAL --nostraliaspriceextension=$SHOP_HOST3_NOSTR_ALIAS_PRICE_EXTENSION --offersrsshtunnels=$SHOP_HOST3_OFFERS_RSSH_TUNNELS --rsshtunnelprice=$SHOP_HOST3_RSSH_TUNNEL_PRICE --tos="$SHOP_HOST3_TERMS_OF_SERVICE" --tosurl="$SHOP_HOST3_TERMS_OF_SERVICE_URL" --cistatus=$SHOP_HOST3_CI_STATUS --cidate="$SHOP_HOST3_CI_DATE" --cimessage="$SHOP_HOST3_CI_MESSAGE" --bridge_bandwidth_initial=$SHOP_HOST3_BRIDGE_BANDWIDTH_INITIAL
  fi
  if [ "True" = $SHOP_HOST4_REGISTER ]; then
    python3 manage.py create_host --owner=$DJANGO_OPERATOR_NAME --sitedomain="$SHOP_SITE_DOMAIN" --name="$SHOP_HOST4_NAME" --description="$SHOP_HOST4_DESCRIPTION" --ip=$SHOP_HOST4_IP --portranges=$SHOP_HOST4_PORT_RANGES --rangetype=$SHOP_HOST4_PORT_RANGE_TYPE --isenabled=$SHOP_HOST4_IS_ENABLED --isalive=$SHOP_HOST4_IS_ALIVE --istesthost=$SHOP_HOST4_IS_TESTHOST --istestnet=$SHOP_HOST4_IS_TESTNET --offerstorbridges=$SHOP_HOST4_OFFERS_TOR_BRIDGES --torbridgeduration=$SHOP_HOST4_TOR_BRIDGE_DURATION --torbridgepriceinitial=$SHOP_HOST4_TOR_BRIDGE_PRICE_INITIAL --torbridgepriceextension=$SHOP_HOST4_TOR_BRIDGE_PRICE_EXTENSION --offersnostraliases=$SHOP_HOST4_OFFERS_NOSTR_ALIASES --nostraliasport=$SHOP_HOST4_NOSTR_ALIAS_PORT --nostraliasduration=$SHOP_HOST4_NOSTR_ALIAS_DURATION --nostraliaspriceinitial=$SHOP_HOST4_NOSTR_ALIAS_PRICE_INITIAL --nostraliaspriceextension=$SHOP_HOST4_NOSTR_ALIAS_PRICE_EXTENSION --offersrsshtunnels=$SHOP_HOST4_OFFERS_RSSH_TUNNELS --rsshtunnelprice=$SHOP_HOST4_RSSH_TUNNEL_PRICE --tos="$SHOP_HOST4_TERMS_OF_SERVICE" --tosurl="$SHOP_HOST4_TERMS_OF_SERVICE_URL" --cistatus=$SHOP_HOST4_CI_STATUS --cidate="$SHOP_HOST4_CI_DATE" --cimessage="$SHOP_HOST4_CI_MESSAGE" --bridge_bandwidth_initial=$SHOP_HOST4_BRIDGE_BANDWIDTH_INITIAL
  fi
  if [ "True" = $SHOP_HOST5_REGISTER ]; then
    python3 manage.py create_host --owner=$DJANGO_OPERATOR_NAME --sitedomain="$SHOP_SITE_DOMAIN" --name="$SHOP_HOST5_NAME" --description="$SHOP_HOST5_DESCRIPTION" --ip=$SHOP_HOST5_IP --portranges=$SHOP_HOST5_PORT_RANGES --rangetype=$SHOP_HOST5_PORT_RANGE_TYPE --isenabled=$SHOP_HOST5_IS_ENABLED --isalive=$SHOP_HOST5_IS_ALIVE --istesthost=$SHOP_HOST5_IS_TESTHOST --istestnet=$SHOP_HOST5_IS_TESTNET --offerstorbridges=$SHOP_HOST5_OFFERS_TOR_BRIDGES --torbridgeduration=$SHOP_HOST5_TOR_BRIDGE_DURATION --torbridgepriceinitial=$SHOP_HOST5_TOR_BRIDGE_PRICE_INITIAL --torbridgepriceextension=$SHOP_HOST5_TOR_BRIDGE_PRICE_EXTENSION --offersnostraliases=$SHOP_HOST5_OFFERS_NOSTR_ALIASES --nostraliasport=$SHOP_HOST5_NOSTR_ALIAS_PORT --nostraliasduration=$SHOP_HOST5_NOSTR_ALIAS_DURATION --nostraliaspriceinitial=$SHOP_HOST5_NOSTR_ALIAS_PRICE_INITIAL --nostraliaspriceextension=$SHOP_HOST5_NOSTR_ALIAS_PRICE_EXTENSION --offersrsshtunnels=$SHOP_HOST5_OFFERS_RSSH_TUNNELS --rsshtunnelprice=$SHOP_HOST5_RSSH_TUNNEL_PRICE --tos="$SHOP_HOST5_TERMS_OF_SERVICE" --tosurl="$SHOP_HOST5_TERMS_OF_SERVICE_URL" --cistatus=$SHOP_HOST5_CI_STATUS --cidate="$SHOP_HOST5_CI_DATE" --cimessage="$SHOP_HOST5_CI_MESSAGE" --bridge_bandwidth_initial=$SHOP_HOST5_BRIDGE_BANDWIDTH_INITIAL
  fi
  if [ "True" = $SHOP_HOST6_REGISTER ]; then
    python3 manage.py create_host --owner=$DJANGO_OPERATOR_NAME --sitedomain="$SHOP_SITE_DOMAIN" --name="$SHOP_HOST6_NAME" --description="$SHOP_HOST6_DESCRIPTION" --ip=$SHOP_HOST6_IP --portranges=$SHOP_HOST6_PORT_RANGES --rangetype=$SHOP_HOST6_PORT_RANGE_TYPE --isenabled=$SHOP_HOST6_IS_ENABLED --isalive=$SHOP_HOST6_IS_ALIVE --istesthost=$SHOP_HOST6_IS_TESTHOST --istestnet=$SHOP_HOST6_IS_TESTNET --offerstorbridges=$SHOP_HOST6_OFFERS_TOR_BRIDGES --torbridgeduration=$SHOP_HOST6_TOR_BRIDGE_DURATION --torbridgepriceinitial=$SHOP_HOST6_TOR_BRIDGE_PRICE_INITIAL --torbridgepriceextension=$SHOP_HOST6_TOR_BRIDGE_PRICE_EXTENSION --offersnostraliases=$SHOP_HOST6_OFFERS_NOSTR_ALIASES --nostraliasport=$SHOP_HOST6_NOSTR_ALIAS_PORT --nostraliasduration=$SHOP_HOST6_NOSTR_ALIAS_DURATION --nostraliaspriceinitial=$SHOP_HOST6_NOSTR_ALIAS_PRICE_INITIAL --nostraliaspriceextension=$SHOP_HOST6_NOSTR_ALIAS_PRICE_EXTENSION --offersrsshtunnels=$SHOP_HOST6_OFFERS_RSSH_TUNNELS --rsshtunnelprice=$SHOP_HOST6_RSSH_TUNNEL_PRICE --tos="$SHOP_HOST6_TERMS_OF_SERVICE" --tosurl="$SHOP_HOST6_TERMS_OF_SERVICE_URL" --cistatus=$SHOP_HOST6_CI_STATUS --cidate="$SHOP_HOST6_CI_DATE" --cimessage="$SHOP_HOST6_CI_MESSAGE" --bridge_bandwidth_initial=$SHOP_HOST6_BRIDGE_BANDWIDTH_INITIAL
  fi
  if [ "True" = $SHOP_HOST7_REGISTER ]; then
    python3 manage.py create_host --owner=$DJANGO_OPERATOR_NAME --sitedomain="$SHOP_SITE_DOMAIN" --name="$SHOP_HOST7_NAME" --description="$SHOP_HOST7_DESCRIPTION" --ip=$SHOP_HOST7_IP --portranges=$SHOP_HOST7_PORT_RANGES --rangetype=$SHOP_HOST7_PORT_RANGE_TYPE --isenabled=$SHOP_HOST7_IS_ENABLED --isalive=$SHOP_HOST7_IS_ALIVE --istesthost=$SHOP_HOST7_IS_TESTHOST --istestnet=$SHOP_HOST7_IS_TESTNET --offerstorbridges=$SHOP_HOST7_OFFERS_TOR_BRIDGES --torbridgeduration=$SHOP_HOST7_TOR_BRIDGE_DURATION --torbridgepriceinitial=$SHOP_HOST7_TOR_BRIDGE_PRICE_INITIAL --torbridgepriceextension=$SHOP_HOST7_TOR_BRIDGE_PRICE_EXTENSION --offersnostraliases=$SHOP_HOST7_OFFERS_NOSTR_ALIASES --nostraliasport=$SHOP_HOST7_NOSTR_ALIAS_PORT --nostraliasduration=$SHOP_HOST7_NOSTR_ALIAS_DURATION --nostraliaspriceinitial=$SHOP_HOST7_NOSTR_ALIAS_PRICE_INITIAL --nostraliaspriceextension=$SHOP_HOST7_NOSTR_ALIAS_PRICE_EXTENSION --offersrsshtunnels=$SHOP_HOST7_OFFERS_RSSH_TUNNELS --rsshtunnelprice=$SHOP_HOST7_RSSH_TUNNEL_PRICE --tos="$SHOP_HOST7_TERMS_OF_SERVICE" --tosurl="$SHOP_HOST7_TERMS_OF_SERVICE_URL" --cistatus=$SHOP_HOST7_CI_STATUS --cidate="$SHOP_HOST7_CI_DATE" --cimessage="$SHOP_HOST7_CI_MESSAGE" --bridge_bandwidth_initial=$SHOP_HOST7_BRIDGE_BANDWIDTH_INITIAL
  fi
  if [ "True" = $SHOP_HOST8_REGISTER ]; then
    python3 manage.py create_host --owner=$DJANGO_OPERATOR_NAME --sitedomain="$SHOP_SITE_DOMAIN" --name="$SHOP_HOST8_NAME" --description="$SHOP_HOST8_DESCRIPTION" --ip=$SHOP_HOST8_IP --portranges=$SHOP_HOST8_PORT_RANGES --rangetype=$SHOP_HOST8_PORT_RANGE_TYPE --isenabled=$SHOP_HOST8_IS_ENABLED --isalive=$SHOP_HOST8_IS_ALIVE --istesthost=$SHOP_HOST8_IS_TESTHOST --istestnet=$SHOP_HOST8_IS_TESTNET --offerstorbridges=$SHOP_HOST8_OFFERS_TOR_BRIDGES --torbridgeduration=$SHOP_HOST8_TOR_BRIDGE_DURATION --torbridgepriceinitial=$SHOP_HOST8_TOR_BRIDGE_PRICE_INITIAL --torbridgepriceextension=$SHOP_HOST8_TOR_BRIDGE_PRICE_EXTENSION --offersnostraliases=$SHOP_HOST8_OFFERS_NOSTR_ALIASES --nostraliasport=$SHOP_HOST8_NOSTR_ALIAS_PORT --nostraliasduration=$SHOP_HOST8_NOSTR_ALIAS_DURATION --nostraliaspriceinitial=$SHOP_HOST8_NOSTR_ALIAS_PRICE_INITIAL --nostraliaspriceextension=$SHOP_HOST8_NOSTR_ALIAS_PRICE_EXTENSION --offersrsshtunnels=$SHOP_HOST8_OFFERS_RSSH_TUNNELS --rsshtunnelprice=$SHOP_HOST8_RSSH_TUNNEL_PRICE --tos="$SHOP_HOST8_TERMS_OF_SERVICE" --tosurl="$SHOP_HOST8_TERMS_OF_SERVICE_URL" --cistatus=$SHOP_HOST8_CI_STATUS --cidate="$SHOP_HOST8_CI_DATE" --cimessage="$SHOP_HOST8_CI_MESSAGE" --bridge_bandwidth_initial=$SHOP_HOST8_BRIDGE_BANDWIDTH_INITIAL
  fi
  if [ "True" = $SHOP_HOST9_REGISTER ]; then
    python3 manage.py create_host --owner=$DJANGO_OPERATOR_NAME --sitedomain="$SHOP_SITE_DOMAIN" --name="$SHOP_HOST9_NAME" --description="$SHOP_HOST9_DESCRIPTION" --ip=$SHOP_HOST9_IP --portranges=$SHOP_HOST9_PORT_RANGES --rangetype=$SHOP_HOST9_PORT_RANGE_TYPE --isenabled=$SHOP_HOST9_IS_ENABLED --isalive=$SHOP_HOST9_IS_ALIVE --istesthost=$SHOP_HOST9_IS_TESTHOST --istestnet=$SHOP_HOST9_IS_TESTNET --offerstorbridges=$SHOP_HOST9_OFFERS_TOR_BRIDGES --torbridgeduration=$SHOP_HOST9_TOR_BRIDGE_DURATION --torbridgepriceinitial=$SHOP_HOST9_TOR_BRIDGE_PRICE_INITIAL --torbridgepriceextension=$SHOP_HOST9_TOR_BRIDGE_PRICE_EXTENSION --offersnostraliases=$SHOP_HOST9_OFFERS_NOSTR_ALIASES --nostraliasport=$SHOP_HOST9_NOSTR_ALIAS_PORT --nostraliasduration=$SHOP_HOST9_NOSTR_ALIAS_DURATION --nostraliaspriceinitial=$SHOP_HOST9_NOSTR_ALIAS_PRICE_INITIAL --nostraliaspriceextension=$SHOP_HOST9_NOSTR_ALIAS_PRICE_EXTENSION --offersrsshtunnels=$SHOP_HOST9_OFFERS_RSSH_TUNNELS --rsshtunnelprice=$SHOP_HOST9_RSSH_TUNNEL_PRICE --tos="$SHOP_HOST9_TERMS_OF_SERVICE" --tosurl="$SHOP_HOST9_TERMS_OF_SERVICE_URL" --cistatus=$SHOP_HOST9_CI_STATUS --cidate="$SHOP_HOST9_CI_DATE" --cimessage="$SHOP_HOST9_CI_MESSAGE" --bridge_bandwidth_initial=$SHOP_HOST9_BRIDGE_BANDWIDTH_INITIAL
  fi
